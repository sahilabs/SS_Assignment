...
regions.forEach(function(regionInfo) {
  ...
  var extracedCol =ee.ImageCollection("ECMWF/ERA5_LAND/HOURLY")
                  .filterBounds(region)
                  .filterDate('2008-08-01', '2024-11-01')  // adjust as needed
...
fileNamePrefix: 'ERA5_land_3km_MyRegion_26july',
  collection: mergedStats,
  description: 'ERA5_land_Timeseries',
  fileFormat: 'CSV'
});
