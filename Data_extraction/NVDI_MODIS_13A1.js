...
regions.forEach(function(regionInfo) {
  ...
  var extracedCol = ee.ImageCollection("MODIS/061/MOD13A1")
                  .filterBounds(region)
                  .filterDate('2008-10-01', '2024-11-01')  // adjust as needed
                  // .filterDate('2024-08-01', '2024-11-01')  // adjust as needed
...
// 5. Print to console
print('All NDVI stats for regions:', mergedStats);


Export.table.toDrive({
fileNamePrefix: 'NDVI_Timeseries',
  collection: mergedStats,
  description: 'NDVI_Timeseries_3km',
  fileFormat: 'CSV'
});
